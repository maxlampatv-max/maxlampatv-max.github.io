(function() {
  ...
  var Defined = {
    use_api: 'lampac',
    localhost: 'http://185.197.74.133:9118/sisi',
    vip_site: '',
    framework: ''
  };
  ...
  if (!window.rch) {
    Lampa.Utils.putScript(["http://185.197.74.133:9118/invc-rch.js"], function() {}, false, function() {
      if (!window.rch.startTypeInvoke)
        window.rch.typeInvoke('http://185.197.74.133:9118', function() {});
    }, true);
  }
  ...
  function rchRun(json, call) {
    if (typeof signalR == 'undefined') {
      Lampa.Utils.putScript(["http://185.197.74.133:9118/signalr-6.0.25_es5.js"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
  ...
  function View(object) {
    ...
    var Search = {
      ...
      search: function search(params, oncomplite) {
        network.silent('http://185.197.74.133:9118/rch/check/connected', function(json) {
          if (json.rch) {
            rchRun(json, function() {
      ...
      button.on('hover:enter', function() {
        ...
        Lampa.ParentalControl.query(function() {
          Api.menu(function(data) {
            ...
            if (true && (Defined.use_api == 'lampac' || Lampa.Platform.is('android'))) {
              items.push({
                title: 'Все'
              });
            }
